...
function userInterface() {
  ...
  function deleteTaskHandler() {
    projectList[this.dataset.project].removeTask(
      projectList[this.dataset.project].taskList[this.dataset.task],
    );
  ...
  function completionToggleAssign() {
    document
      ...
      .addEventListener("click", completionToggle);
  }

  function completionToggle() {
    projectList[this.dataset.project].taskList[
      this.dataset.task
    ].toggleCompletion();
  ...
  function priorityBtnAssign() {
    document
      ...
      .addEventListener("click", priorityToggle);
  }
  ...
  function collapseAssign() {
    document.querySelector(".retract-button").addEventListener("click", () => {
      displayMicroTasks(
        projectList[document.querySelector(".retract-button").dataset.project],
      );
    });
  }
